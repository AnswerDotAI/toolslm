...
is like `python`, except it also maintains a stateful interpreter,
rather than just running a single line of code. This is implemented
using IPython, so that must be installed.
...
```
    ...
    Traceback (most recent call last):
      File "<ipython-input-1-6be3997d5392>", line 1, in <module>
        try: print(1/0)
                   ~^~
...
<a
href="https://github.com/AnswerDotAI/toolslm/blob/main/toolslm/shell.py#L21"
...
<a
href="https://github.com/AnswerDotAI/toolslm/blob/main/toolslm/shell.py#L37"
target="_blank" style="float:right; font-size:smaller">source</a>

### get_shell

``` python
def get_shell()->IPython.terminal.interactiveshell.TerminalInteractiveShell:
```
