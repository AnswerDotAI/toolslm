...
<a
href="https://github.com/AnswerDotAI/toolslm/blob/main/toolslm/funccall.py#L127"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/toolslm/blob/main/toolslm/funccall.py#L168"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/toolslm/blob/main/toolslm/funccall.py#L185"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/toolslm/blob/main/toolslm/funccall.py#L194"
target="_blank" style="float:right; font-size:smaller">source</a>
...
How do I get the whole traceback of an error instead of just str(e) like
above?

To get the whole traceback of an error instead of just `str(e)`, you can
use the `traceback` module, which you’ve already imported in your code.
Modify the
[`call_func`](https://AnswerDotAI.github.io/toolslm/funccall.html#call_func)
function to capture and return the full traceback when an error occurs:
...
This replaces `str(e)` with `traceback.format_exc()`, which returns the
full traceback as a string, including the error type, message, and the
call stack that led to the error. This gives you much more context about
