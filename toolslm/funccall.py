"""Docs: https://AnswerDotAI.github.io/toolslm/funccall.html.md"""
...
# %% ../nbs/01_funccall.ipynb #a9f43047
empty = inspect.Parameter.empty

# %% ../nbs/01_funccall.ipynb #4d5dc245
...
# %% ../nbs/01_funccall.ipynb #f77bea1c
...
# %% ../nbs/01_funccall.ipynb #748da965
def get_schema(
...
# %% ../nbs/01_funccall.ipynb #873000d7
import ast, signal, traceback
from fastcore.utils import *

# %% ../nbs/01_funccall.ipynb #4703296a
...
# %% ../nbs/01_funccall.ipynb #1574585f
...
# %% ../nbs/01_funccall.ipynb #81857615
def minipy(
...
# %% ../nbs/01_funccall.ipynb #782c4415
def mk_ns(fs):
...
# %% ../nbs/01_funccall.ipynb #6ef23838
...
# %% ../nbs/01_funccall.ipynb #925f462b
def resolve_nm(nm, ns):
    st,*rest = nm.split('.')
    return reduce(getattr, rest, ns[st])

# %% ../nbs/01_funccall.ipynb #6f6b5bfa
...
# %% ../nbs/01_funccall.ipynb #f1e7f8b4
def _norm_nm(nm, repl=''): return re.sub(r'\W', repl, nm)

# %% ../nbs/01_funccall.ipynb #2fca0f67
def _py_nm(nm):
    nm = _norm_nm(nm, '_')
    if not nm: return '_'
...
# %% ../nbs/01_funccall.ipynb #1625929e
def _nm_map(nms):
    py2orig = {}
    for orig in nms:
        pynm = _py_nm(orig)
...
# %% ../nbs/01_funccall.ipynb #47b49644
...
# %% ../nbs/01_funccall.ipynb #73bca085
...
# %% ../nbs/01_funccall.ipynb #5a2588d5
...
# %% ../nbs/01_funccall.ipynb #bb16561a
...
# %% ../nbs/01_funccall.ipynb #2cd26f9a
