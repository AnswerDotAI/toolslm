# AUTOGENERATED! DO NOT EDIT! File to edit: ../01_funccall_dates.ipynb.

# %% auto 0
__all__ = ['empty', 'custom_types', 'get_schema', 'PathArg', 'python', 'mk_ns', 'call_func', 'call_func_async']

# %% ../01_funccall_dates.ipynb
import inspect
...
def call_func(fc_name, fc_inputs, ns, raise_on_err=True):
    ...
    inps = {p: d[p].anno(v) if d[p].anno in custom_types else v for p, v in inps.items()}
