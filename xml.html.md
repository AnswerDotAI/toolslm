...
<a
href="https://github.com/AnswerDotAI/toolslm/blob/main/toolslm/xml.py#L24"
...
{ 'cell_type': 'code',
  ...
  'id': '005a5be4',
  'metadata': {},
  'outputs': [{'data': {'text/markdown': ['```html\n', '<person>\n', '  <surname>Howard</surname>\n', '  <firstnames>\n', '    <item>Jeremy</item>\n', '    <item>Peter</item>\n', '  </firstnames>\n', '  <address>\n', '    <state>Queensland</state>\n', '    <country>Australia</country>\n', '  </address>\n', '</person>\n', '```'], 'text/plain': ['<IPython.core.display.Markdown object>']}, 'execution_count': None, 'metadata': {}, 'output_type': 'execute_result'}],
...
<a
href="https://github.com/AnswerDotAI/toolslm/blob/main/toolslm/xml.py#L41"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/toolslm/blob/main/toolslm/xml.py#L47"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/toolslm/blob/main/toolslm/xml.py#L60"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/toolslm/blob/main/toolslm/xml.py#L80"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/toolslm/blob/main/toolslm/xml.py#L74"
target="_blank" style="float:right; font-size:smaller">source</a>
...
``` python
def cells2xml(
    cells, wrap:functools.partial=functools.partial(<function ft at 0x7f928f5c7600>, 'notebook'), *, out:bool=True,
    ids:bool=True, nums:bool=False
):
```
...
<a
href="https://github.com/AnswerDotAI/toolslm/blob/main/toolslm/xml.py#L98"
target="_blank" style="float:right; font-size:smaller">source</a>
...
)-><function namedtuple at 0x7f9290b47f60>:
```
...
<a
href="https://github.com/AnswerDotAI/toolslm/blob/main/toolslm/xml.py#L107"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/toolslm/blob/main/toolslm/xml.py#L120"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/toolslm/blob/main/toolslm/xml.py#L137"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/toolslm/blob/main/toolslm/xml.py#L150"
target="_blank" style="float:right; font-size:smaller">source</a>
...
``` python
def files2ctx(
    fnames:list[typing.Union[str, pathlib.Path]], # List of file names to add to context
...
<a
href="https://github.com/AnswerDotAI/toolslm/blob/main/toolslm/xml.py#L168"
target="_blank" style="float:right; font-size:smaller">source</a>
...
*Convert folder contents to XML context, handling notebooks; prints
instead of returning when run as a CLI*
...
<a
href="https://github.com/AnswerDotAI/toolslm/blob/main/toolslm/xml.py#L196"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/toolslm/blob/main/toolslm/xml.py#L203"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/toolslm/blob/main/toolslm/xml.py#L213"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/toolslm/blob/main/toolslm/xml.py#L221"
target="_blank" style="float:right; font-size:smaller">source</a>
...
```
    ...
    usage: folder2ctx [-h] [--path PATH] [--no-out] [--prefix] [--no-include-base]
                      [--title TITLE] [--max-size MAX_SIZE] [--max-total MAX_TOTAL]
                      [--readme-first] [--files-only] [--sigs-only] [--no-ids]
                      [--no-recursive] [--no-symlinks] [--file-glob FILE_GLOB]
                      [--file-re FILE_RE] [--folder-re FOLDER_RE]
                      [--skip-file-glob SKIP_FILE_GLOB]
                      [--skip-file-re SKIP_FILE_RE]
                      [--skip-folder-re SKIP_FOLDER_RE] [--ret-folders] [--no-sort]
    ...
    options:
      ...
      --prefix                         Include Anthropic's suggested prose intro?
                                       (default: False)
      --no-include-base                Include full path in src? (default: True)
      --title TITLE                    Optional title attr for Documents element
      --max-size MAX_SIZE              Skip files larger than this (bytes) (default:
                                       100000)
      --max-total MAX_TOTAL            Max total output size in bytes (default:
                                       10000000)
      --readme-first                   Prioritize README files at start of context?
                                       (default: False)
      --files-only                     Return dict of {filename: size} instead of
                                       context? (default: False)
      --sigs-only                      Return signatures instead of full text for
      ...
      --file-glob FILE_GLOB            Only include files matching glob
      --file-re FILE_RE                Only include files matching regex
      --folder-re FOLDER_RE            Only enter folders matching regex
      --skip-file-glob SKIP_FILE_GLOB  Skip files matching glob
      --skip-file-re SKIP_FILE_RE      Skip files matching regex
      --skip-folder-re SKIP_FOLDER_RE  Skip folders matching regex,
      --ret-folders                    return folders, not just files (default:
                                       False)
...
<a
href="https://github.com/AnswerDotAI/toolslm/blob/main/toolslm/xml.py#L232"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/toolslm/blob/main/toolslm/xml.py#L240"
target="_blank" style="float:right; font-size:smaller">source</a>
...
*Convert GitHub repo to XML context without cloning; prints instead of
returning when run as a CLI*

``` python
s = set(inspect.signature(repo2ctx).parameters)
test_eq(s & {'path','include_base','title','readme_first'}, set())
```

``` python
print(await repo2ctx('answerdotai/toolslm', exts=('ipynb','py'), skip_file_re='^_', out=False, max_total=500))
```
...
``` python
print(await repo2ctx('answerdotai/toolslm', types='py', skip_file_re='^_', out=False, files_only=True))
```
...
``` python
print(await repo2ctx('https://github.com/AnswerDotAI/toolslm/tree/main/nbs/samples'))
```
